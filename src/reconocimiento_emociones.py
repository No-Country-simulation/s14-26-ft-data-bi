...
#     df_emociones.to_csv("../data/resultados/emociones6.csv", index=False)
...
def reconocimiento_emociones(ruta_video, duracion_analisis):
    ...
    df_emociones = pd.DataFrame(df_emociones)
    df_emociones.to_csv("../data/resultados/emociones_clase6.csv", index=False)

# Llamada a la función con la duración de análisis deseada
ruta_video = "../data/pruebas/clase6.mp4"
